-- Insert Department data first since Employee references it
...
-- Update Department Manager_IDs now that we have Employee data
...
('INS001', 'D202401001', 'E001', 'Physical', '2024-01-18', N'Cảng Cát Lái', 'Completed', N'Nguyễn Văn A', N'Đạt', N'Hàng hóa đúng khai báo'),
...
-- Insert Document data (using NULL for VARBINARY fields as placeholder)
...
-- Insert Payment data
INSERT INTO Payment (Payment_ID, Contract_ID, Tax_Fee, Amount, Payment_Date) VALUES
